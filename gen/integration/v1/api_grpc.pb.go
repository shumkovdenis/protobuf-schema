...
const (
	IntegrationService_GetBalance_FullMethodName = "/integration.v1.IntegrationService/GetBalance"
)
...
func (c *integrationServiceClient) GetBalance(ctx context.Context, in *GetBalanceRequest, opts ...grpc.CallOption) (*GetBalanceResponse, error) {
	out := new(GetBalanceResponse)
	err := c.cc.Invoke(ctx, IntegrationService_GetBalance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIntegrationServiceServer) GetBalance(context.Context, *GetBalanceRequest) (*GetBalanceResponse, error) {
...
func _IntegrationService_GetBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntegrationServiceServer).GetBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IntegrationService_GetBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntegrationServiceServer).GetBalance(ctx, req.(*GetBalanceRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _IntegrationService_GetBalance_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "integration/v1/api.proto",
}
